...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><i class="fa fa-users" style="padding-right: 10px"></i>Available Blood Donar List</h2>
                    ...
                    <td>
                        <?php
                          if ($row['last_donate_date']=='01/01/2001') {
                            // echo "<b style='color: rgb(51,122,183);'>Never donated</b>";
                            echo '<span class="badge" style="background-color:rgb(51,122,183);">Never donated</span>';
                          } else{
                            echo $row['last_donate_date']."<br><b style='color:rgb(38, 186, 152);'>".$days.' days ago</b.';
                          }
                        ?>
                    </td>
                  ...
                  <table class="table" style="min-width: 100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <tr>
                          <td> Duration </td>
                          <td> <b style="color:rgb(38, 186, 152);" id="last_date_days_diff"></b> </td>
                        </tr>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div class="x_content">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td colspan="2">
                          <button id="donate_today" class="btn btn-block btn-sm btn-success"><i class="fa fa-tint" style="padding-right: 5px"></i>Donate today</button>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
