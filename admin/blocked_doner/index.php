...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><i class="fa fa-users" style="padding-right: 10px"></i>Muted Blood Donar List</h2>
      ...
      <div class="x_content">
        ...
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            $days = 0;
            $status = 0;
              $sql = "SELECT * FROM donar_list WHERE muted=1 && del=0;";
                    ...
                    <td>
                      <?php
                        if ($row['last_donate_date']=='01/01/2001') {
                          ...
                          echo $row['last_donate_date']."<br>".$days." days ago";
                        }
                      ?>
                    </td>
                ...
                <div class="x_content">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td colspan="2">
                          <button id="unmute" class="btn btn-block btn-sm btn-success"><i class="fa fa-check" style="padding-right: 5px"></i>Unmute this donor</button>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
                          <button id="delete" class="btn btn-block btn-sm btn-danger"><i class="fa fa-trash-o" style="padding-right: 5px"></i>Delete this donor</button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
...
<script>
  $(document).on('click', '#view', function(){
    ...
    // un mute donor
    $(document).on('click', '#unmute', function(event){
      console.log(donor_id);
      event.preventDefault();
        ...
        confirmButtonText: 'Yes, unmute this donor!'
      }).then((result) => {
        if (result.value) {
          $.ajax({
            url: 'ajax.php',
            method: 'POST',
            dataType: 'json',
            data: { donor_id: donor_id, action: 'unmute'},
    ...
    $(document).on('click', '#delete', function(event){
      ...
      event.preventDefault();
        ...
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: 'Yes, delete this donor!'
      }).then((result) => {
        if (result.value) {
          $.ajax({
            url: 'ajax.php',
            method: 'POST',
            dataType: 'json',
            data: { donor_id: donor_id, action: 'delete'},
