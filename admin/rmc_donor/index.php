...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><i class="fa fa-graduation-cap" style="margin-right: 5px"></i> RMC Blood Donar List</h2>
      ...
      <div class="x_content">
        ...
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            $days = 0;
            $status = 0;
              $sql = "SELECT * FROM donar_list WHERE muted=0 && del=0 && rmc=1;";
              ...
              if( $result_check > 0 ){
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  // donate day count
                    ...
                    <td>
                      <button type="button" id="view" data-id="<?php echo $row['id']; ?>" class="btn btn-xs btn-primary" data-toggle="modal" data-target=".view-tazbinur-rahaman"><i class="fa fa-eye" style="padding-right: 5px"></i>View</button>
                      <button type="button" class="btn btn-xs btn-default" id="edit" data-id="<?php echo $row['id']; ?>" data-toggle="modal" data-target=".edit-tazbinur-rahaman"><i class="fa fa-pencil" style="padding-right: 5px"></i>Edit</button>
                    </td>
                    </tr>
                    <?php
                }
                    ...
                    <tbody>
                      <tr>
                        <td colspan="2" id="donate_today">
                          <button class="btn btn-block btn-sm btn-success"><i class="fa fa-tint" style="padding-right: 5px"></i>Donate today</button>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel2"><i class="fa fa-user" style="padding-right: 10px"></i>Donor data edit</h4>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="save_changes" class="btn btn-sm btn-success"><i class="fa fa-check" style="padding-right: 5px"></i>Save changes</button>
      </div>
